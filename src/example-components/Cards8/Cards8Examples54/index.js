...
export default function LivePreviewExample() {
  return (
    <Fragment>
      <div className="bg-plum-plate pt-4 px-4 mb-4 rounded">
        <Grid container spacing={4}>
          <Grid item xs={12} sm={6} lg={3}>
            <a
              href="#/"
              onClick={e => e.preventDefault()}
              className="mb-4 card card-box card-box-border-bottom border-success card-box-hover-rise-alt">
          ...
          <Grid item xs={12} sm={6} lg={3}>
            <a
              href="#/"
              onClick={e => e.preventDefault()}
              className="mb-4 card card-box card-box-border-bottom border-danger card-box-hover-rise-alt">
              <CardContent className="p-3">
                <div className="align-box-row">
                  <div className="text-left">
                    <div className="mt-1">
          ...
          <Grid item xs={12} sm={6} lg={3}>
            <a
              href="#/"
              onClick={e => e.preventDefault()}
              className="mb-4 card card-box card-box-border-bottom border-warning card-box-hover-rise-alt">
              <CardContent className="p-3">
                <div className="align-box-row">
                  <div className="text-left">
                    <div className="mt-1">
          ...
          <Grid item xs={12} sm={6} lg={3}>
            <a
              href="#/"
              onClick={e => e.preventDefault()}
              className="mb-4 card card-box card-box-border-bottom border-info card-box-hover-rise-alt">
              <CardContent className="p-3">
                <div className="align-box-row">
                  <div className="text-left">
                    <div className="mt-1">
