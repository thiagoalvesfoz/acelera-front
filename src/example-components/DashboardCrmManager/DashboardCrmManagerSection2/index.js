          ...
          <Card className="mb-4 text-center px-4 pb-4 pt-2">
            <div className="gauge-wrapper">
              <Circle
                ...
                bgColor="rgba(255,255,255,.1)" // String: Color of "empty" portion of circle.
                textColor="#3b3e66" // String: Color of percentage text color.percentSpacing={10} // Number: Adjust spacing of "%" symbol and number.
                roundedStroke={true}
                textStyle={{
                  fontSize: '60px'
            ...
            <div className="text-black-50">Task manager</div>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} lg={3}>
          <Card className="mb-4 text-center px-4 pb-4 pt-2">
            <div className="gauge-wrapper">
              <Circle
                ...
                bgColor="rgba(255,255,255,.07)" // String: Color of "empty" portion of circle.
                textColor="#3b3e66" // String: Color of percentage text color.percentSpacing={10} // Number: Adjust spacing of "%" symbol and number.
                roundedStroke={true}
                textStyle={{
                  fontSize: '60px'
            ...
            <div className="text-black-50">Analytics statistics</div>
          </Card>
        </Grid>
      </Grid>
    </Fragment>
